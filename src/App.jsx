...
const APP = () => {
    return (
        ...
        <>
            <UseGlobalProvider>
                <MainHeader />
                <section className="grid grid-cols-[1fr] lg:grid lg:grid-cols-[1fr_3fr] mt-6 md:gap-4 max-h-[screen] md:grid md:grid-cols-1 md:max-h-[50%] md:mx-auto md:max-w-[920px] lg:min-w-[1010px] font-500 text-xl mb-4 lg:mx-auto dark:bg-slate-950">
                    <Section_1 />
                    <Section_2 />
                </section>
